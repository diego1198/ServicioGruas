...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 09-12-2019 a las 06:28:26
...
('1710893113', 1719568378, 'EDISON', 'LASCANO', 'C'),
...
CREATE TABLE `service` (
  ...
  `servDistance` varchar(30) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
INSERT INTO `service` (`servid`, `service_date`, `servbrand`, `servmodel`, `servcolor`, `servplate`, `servorig`, `servdest`, `servcost`, `servunity`, `servDistance`) VALUES
...
('19345', '2018-07-21', 'Alpine', 'A110', 'NEGRO', 'PJG2431', 'SANGOLQUI', 'CHILLOGALLO', '7', '0', ''),
('19423', '2018-07-26', 'Audi', 'Q7', 'NEGRO', 'GTE3244', 'GUAMANI', 'PONCEANO', '7', '0', ''),
...
('19499', '2019-11-13', 'KIA', 'Rio', 'White', 'PHG-1932', 'SANGOLQUI', 'REINA VICTORIA', '80', '0', ''),
...
('19566', '2019-12-11', 'Chevrolet', NULL, NULL, 'PQJ0987', 'Quito', 'Santo Dom', '120', NULL, '');
