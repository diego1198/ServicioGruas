...
public class Service {
    ...
    private String servDistance;
    private String servUnity;

    public Service(String servid, String serviceDate, String servBrand, String servModel, String servColor, String servPlate, String servOrig, String servDest, float servCost, String servDistance, String servUnity) {
        this.servid = servid;
        ...
        this.servDistance = servDistance;
    ...
    /**
     * @return the servDistance
     */
    public String getServDistance() {
        return servDistance;
    }

    /**
     * @param servDistance the servDistance to set
     */
    public void setServDistance(String servDistance) {
        this.servDistance = servDistance;
    }
